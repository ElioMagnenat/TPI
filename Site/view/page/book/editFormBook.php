        ...
        <div class="card-body">
            <form id="editFormBook" method="post" action="?controller=book&action=updateBook&id=<?= $book[0]['id_book'] ?>" enctype="multipart/form-data">
                <div class="mb-3">
                    ...
                    <span id="errorTitle" class="alert-danger" style="display: none;">Veuillez entrer un titre</span>
                </div>

                <div class="mb-3">
                    <label for="author" class="form-label">Auteur</label>
                    <input class="form-control" name="author" id="author" value="<?= $book[0]['author'] ?>" placeholder="Auteur du livre">
                    <span id="errorAuthor" class="alert-danger" style="display: none;">Veuillez entrer un auteur</span>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <span id="errorEdition" class="alert-danger" style="display: none;">Veuillez entrer une maison d'édition</span>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <span id="errorCategory" class="alert-danger" style="display: none;">Veuillez sélectionner une catégorie</span>
                </div>

                <div class="mb-3">
                    <label for="reference" class="form-label">Référence</label>
                    <input class="form-control" name="reference" id="reference" value="<?= $book[0]['reference'] ?>" placeholder="Ex: E5">
                    <span id="errorReference" class="alert-danger" style="display: none;">Veuillez entrer une étagère</span>
                </div>

                <div class="mb-3">
                    <label for="location" class="form-label">Emplacement</label>
                    <input class="form-control" name="location" id="location" value="<?= $book[0]['location'] ?>" placeholder="Ex: 1">
                    <span id="errorLocation" class="alert-danger" style="display: none;">Veuillez entrer un rayon</span>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <span id="errorPicture" class="alert-danger" style="display: none;"></span>
                </div>
